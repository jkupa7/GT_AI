...
class DecisionTreePart1Tests(unittest.TestCase):
    ...
    def test_hand_tree_accuracy(self):
        ...
        for index in range(0, len(self.ht_examples)):
            # print(self.ht_examples[index])͏︍͏︆͏󠄁
...
class VectorizationWarmUpTests(unittest.TestCase):
    ...
    def test_vectorized_flatten(self):
        ...
        # print(f"UNIQUE: {answer_unique}")
        # print(f"MY UNIQUE: {my_unique}")
        # print(f"DIFF: {set(answer_unique) - set(my_unique)}")
...
if __name__ == '__main__':
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(DecisionTreePart2Tests)
